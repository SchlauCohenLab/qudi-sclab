...
""")
    ...
    if test_signal:
        ...
        tagger.setTriggerLevel(CHAN_START, 0)

        tagger.setEventDivider(CHAN_START, 20)

        tagger.setTriggerLevel(CHAN_STOP1, 1)

        tagger.setDelaySoftware(CHAN_STOP1, 8.5e-9*1e12)

        tagger.setTriggerLevel(CHAN_STOP2, 1)

        tagger.setDelaySoftware(CHAN_STOP2, 8.5e-9*1e12)
